...
public type ErrorMessageForbidden record {|
    *http:Forbidden;
    ErrorMessage body;
|};
...
# Represents the Queries record for the operation: removeOrder
public type RemoveOrderQueries record {
    # The email on the customer's VoltMart account, used to verify ownership
    string email;
};

# Represents the Queries record for the operation: getOrder
public type GetOrderQueries record {
    # The email on the customer's VoltMart account
    string email;
};
